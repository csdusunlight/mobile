...
urlpatterns = [
    ...
    url(r'^welfare_task/$', 'account.views.welfare_task', name='account_welfare_task'),
    url(r'^welfare_finance/$', 'account.views.welfare_finance', name='account_welfare_finance'),
    url(r'^welfare_media/$', 'account.views.welfare_media', name='account_welfare_media'),
    url(r'^welfare_team/$', 'account.views.welfare_team', name='account_welfare_team'),
    url(r'^detail_finance/(?P<id>[0-9]+)$', 'account.views.detail_finance', name='account_detail_finance'),
    url(r'^detail_team/(?P<id>[0-9]+)$', 'account.views.detail_team', name='account_detail_team'),
    url(r'^detail_media/(?P<id>[0-9]+)$', 'account.views.detail_media', name='account_detail_media'),
